...
def example_analyze_patient():
    ...
    results = llm_interface.analyze_patient_for_transfer(
        patient_vignette, target_campuses
    )
    ...
    print(
        f"Extraction Source: {results['extracted_patient_data']['extraction_source']}"
    )
