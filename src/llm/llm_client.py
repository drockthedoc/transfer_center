...
class LLMClient:
    ...
    def __init__(self, provider: str = "openai", api_key: Optional[str] = None):
        ...
        if not self.api_key:
            logger.warning(f"No API key provided for {provider}. Some functions may not work.")
    ...
    def _generate_openai(self, prompt: str, max_tokens: int = 2000, temperature: float = 0.0) -> str:
        """
    ...
    def _generate_anthropic(self, prompt: str, max_tokens: int = 2000, temperature: float = 0.0) -> str:
        """
