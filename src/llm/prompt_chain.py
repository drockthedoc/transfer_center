...
class PromptChainOrchestrator:
    ...
    def _construct_specialty_assessment_prompt(
        self,
        extracted_entities: Dict[str, Any],
        specialty_indicators: Dict[str, List[str]],
    ) -> str:
        """
    ...
    def _construct_exclusion_evaluation_prompt(
        self,
        extracted_entities: Dict[str, Any],
        campus_name: str,
        campus_exclusions: Dict[str, Any],
    ) -> str:
        """
    ...
    def _construct_final_recommendation_prompt(
        self,
        extracted_entities: Dict[str, Any],
        specialty_assessment: Dict[str, Any],
        exclusion_evaluation: Dict[str, Any],
    ) -> str:
        """
        ...
        combined_data = {
            ...
            "exclusion_criteria_evaluation": exclusion_evaluation.get(
                "exclusion_criteria_evaluation", []
            ),
        }
    ...
    def run_analysis_chain(
        self, vignette_text: str, campus_name: str
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            extracted_entities = {
                ...
                "medical_history": (
                    patient_data.clinical_history
                    if hasattr(patient_data, "clinical_history")
                    else ""
                ),
                "clinical_context": "",
            }
            ...
            if hasattr(patient_data, "chief_complaint"):
                extracted_entities["medical_problems"].append(
            ...
            logger.warning(
                f"Fallback method failed, using LLM for entity extraction: {e}"
            )
        ...
        specialty_prompt = self._construct_specialty_assessment_prompt(
            extracted_entities, specialty_indicators
        )
...
def analyze_clinical_vignette(
    vignette_text: str, campus_name: str, llm_client, exclusion_criteria: Dict[str, Any]
) -> Dict[str, Any]:
    """
