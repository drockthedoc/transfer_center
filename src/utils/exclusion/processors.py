    ...
    for section in sections:
        ...
        for item in exclusions:
            ...
            if current_dept == "general":
                ...
                if age_restrictions:
                    result["departments"][current_dept]["age_restrictions"].update(age_restrictions)
                    
                weight_restrictions = extract_weight_restriction(item)
                if weight_restrictions:
                    result["departments"][current_dept]["weight_restrictions"].update(weight_restrictions)
...
def process_special_sections(text: str, result: Dict[str, Any]) -> None:
    ...
    for section in age_sections:
        ...
        for dept_name, criteria in dept_matches:
            ...
            if dept != "general":
                ...
                if age_restrictions:
                    result["departments"][dept]["age_restrictions"].update(age_restrictions)
    ...
    weight_sections = re.findall(weight_section_pattern, text, re.IGNORECASE | re.DOTALL)
    ...
    for section in weight_sections:
        ...
        for dept_name, criteria in dept_matches:
            ...
            if dept != "general":
                ...
                if weight_restrictions:
                    result["departments"][dept]["weight_restrictions"].update(weight_restrictions)
